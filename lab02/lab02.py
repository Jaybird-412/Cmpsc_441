...
def best_hand(hand):
    ...
    #gets every combination for 5 cards in a hand
    all_comb = itertools.combinations(hand, 5)

    #comparing all handranks to combinations
    best = max(all_comb, key = hand_rank)
